...
const getCuestionTerror = () =>{
  cuestionOneTerror.innerHTML = "1. ¿Cuál de estas películas pertenece al género de Terror? <br/><button id='buttonResA'>A. Monster Inc.</button> <br/><button>B. El resplandor</button><br/><button>C. Frankewinie</button>"
}
